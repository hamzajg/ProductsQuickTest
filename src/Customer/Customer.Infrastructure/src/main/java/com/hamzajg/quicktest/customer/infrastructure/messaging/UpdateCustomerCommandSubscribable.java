...
public class UpdateCustomerCommandSubscribable implements Subscribable {
    private Set<Class<?>> supports = new HashSet<>(Collections.singletonList(UpdateCustomer.class));
    private CommandHandler commandHandler;

    public UpdateCustomerCommandSubscribable(CommandHandler commandHandler) {
