...
public class DeleteCustomerCommandSubscribable implements Subscribable {
    private Set<Class<?>> supports = new HashSet<>(Collections.singletonList(DeleteCustomer.class));
    private CommandHandler commandHandler;

    public DeleteCustomerCommandSubscribable(CommandHandler commandHandler) {
