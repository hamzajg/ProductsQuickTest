package com.hamzajg.quicktest.product.infrastructure.messaging.product.category.delete;
...
public class DeleteProductCategoryCommandSubscribable implements Subscribable {
    private Set<Class<?>> supports = new HashSet<>(Collections.singletonList(DeleteProductCategory.class));
    private CommandHandler commandHandler;

    public DeleteProductCategoryCommandSubscribable(CommandHandler commandHandler) {
