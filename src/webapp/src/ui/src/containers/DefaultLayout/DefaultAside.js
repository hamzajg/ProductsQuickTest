...
import { CAppSwitch } from '@coreui/react'
          ...
          <TabPane tabId="3" className="p-3">
            ...
            <div className="aside-options">
              <div className="clearfix mt-4">
                ...
                <CAppSwitch className={'float-right'} variant={'pill'} label color={'success'} defaultChecked size={'sm'}/>
              </div>
              <div>
                <small className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <div className="aside-options">
              <div className="clearfix mt-3">
                ...
                <CAppSwitch className={'float-right'} variant={'pill'} label color={'success'} size={'sm'}/>
              </div>
              <div>
                <small className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                  tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div className="aside-options">
              <div className="clearfix mt-3">
                ...
                <CAppSwitch className={'float-right'} variant={'pill'} label color={'success'} defaultChecked size={'sm'} disabled/>
                <div>
